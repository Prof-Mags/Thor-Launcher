 ...
 * screen â€” so it cannot outlive the activity and a service that could buys nothing.
 ...
 * display through `MediaProjection`, so it keeps capturing inside a game â€” which is
 * the point of it â€” and it therefore needs somewhere to live that is not a screen the
